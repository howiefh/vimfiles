...
if	s:MSWIN
  " ==========  MS Windows  ======================================================
	...
	if match(	substitute( expand("<sfile>"), '\', '/', 'g' ), 
		...
		let s:C_LocalTemplateFile		= s:plugin_dir.'/c-support/templates/WIN_Templates'
		...
		let s:C_GlobalTemplateFile  = s:C_GlobalTemplateDir.'/WIN_Templates'
		let s:C_LocalTemplateFile		= $HOME.'/vimfiles/c-support/templates/WIN_Templates'
		let s:C_LocalTemplateDir		= fnamemodify( s:C_LocalTemplateFile, ":p:h" ).'/'
	endif
	"
  let s:C_FilenameEscChar 			= ''
  ...
  " ==========  Linux/Unix  ======================================================
	...
	if match( expand("<sfile>"), resolve( expand("$HOME") ) ) == 0
		...
		let s:C_LocalTemplateFile		= s:plugin_dir.'/c-support/templates/UNIX_Templates'
		let s:C_LocalTemplateDir		= fnamemodify( s:C_LocalTemplateFile, ":p:h" ).'/'
	else
		" SYSTEM WIDE INSTALLATION
		let s:installation					= 'system'
		...
		let s:C_LocalTemplateFile		= $HOME.'/.vim/c-support/templates/UNIX_Templates'
		let s:C_LocalTemplateDir		= fnamemodify( s:C_LocalTemplateFile, ":p:h" ).'/'
	endif
	"
  let s:C_FilenameEscChar 			= ' \%#[]'
